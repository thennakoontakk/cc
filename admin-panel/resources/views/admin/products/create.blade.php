        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select id="category" name="category" class="form-control @error('category') is-invalid @enderror" required>
                    ...
                    <option value="New Arrivals" {{ old('category') == 'New Arrivals' ? 'selected' : '' }}>New Arrivals</option>
                    <option value="Wall Hangings" {{ old('category') == 'Wall Hangings' ? 'selected' : '' }}>Wall Hangings</option>
                    <option value="Hand Painted Items" {{ old('category') == 'Hand Painted Items' ? 'selected' : '' }}>Hand Painted Items</option>
                    <option value="Decorative Items" {{ old('category') == 'Decorative Items' ? 'selected' : '' }}>Decorative Items</option>
