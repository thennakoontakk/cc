    ...
    <nav class="sidebar">
        <div class="p-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('admin.cart.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.cart.index')); ?>">
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                ...
                <h5 class="mb-0 ms-3"><?php echo $__env->yieldContent('page-title', 'Admin Panel'); ?></h5>
                <div class="ms-auto">
...
</html><?php /**PATH C:\Users\thenn\OneDrive\Desktop\softora\08 25\admin-panel\resources\views/layouts/shared.blade.php ENDPATH**/ ?>